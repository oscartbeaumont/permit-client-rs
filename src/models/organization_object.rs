...
impl OrganizationObject {
    pub fn new(id: Option<serde_json::Value>, key: Option<serde_json::Value>, created_at: Option<serde_json::Value>, updated_at: Option<serde_json::Value>) -> OrganizationObject {
        OrganizationObject {
            id,
            key,
            name: None,
