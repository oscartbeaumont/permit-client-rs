...
pub struct DetailedAuditLogModel {
    #[serde(rename = "id")]
    pub id: uuid::Uuid,
    #[serde(rename = "raw_data")]
    pub raw_data: Box<models::RawData>,
    ...
    pub objects: Box<models::AuditLogObjectsModel>,
}

impl DetailedAuditLogModel {
    pub fn new(id: uuid::Uuid, raw_data: models::RawData, timestamp: String, org_id: uuid::Uuid, project_id: uuid::Uuid, env_id: uuid::Uuid, pdp_config_id: uuid::Uuid, objects: models::AuditLogObjectsModel) -> DetailedAuditLogModel {
        DetailedAuditLogModel {
            id,
            raw_data: Box::new(raw_data),
            timestamp,
            query: None,
            user_key: None,
            user_email: None,
