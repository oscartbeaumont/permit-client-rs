...
pub struct ResponseListRolesV2SchemaProjIdEnvIdRolesGet {
    /// List of Roles
...
impl ResponseListRolesV2SchemaProjIdEnvIdRolesGet {
    pub fn new(data: Option<serde_json::Value>, total_count: Option<serde_json::Value>) -> ResponseListRolesV2SchemaProjIdEnvIdRolesGet {
