...
pub struct EnvironmentReadWithEmailConfig {
    ...
    #[serde(rename = "email_configuration")]
    pub email_configuration: uuid::Uuid,
}

impl EnvironmentReadWithEmailConfig {
    pub fn new(key: String, id: uuid::Uuid, organization_id: uuid::Uuid, project_id: uuid::Uuid, created_at: String, updated_at: String, name: String, email_configuration: uuid::Uuid) -> EnvironmentReadWithEmailConfig {
