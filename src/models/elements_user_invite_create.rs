...
pub struct ElementsUserInviteCreate {
...
impl ElementsUserInviteCreate {
    pub fn new(key: String, status: models::UserInviteStatus, email: String, first_name: String, last_name: String, role_id: uuid::Uuid, tenant_id: uuid::Uuid) -> ElementsUserInviteCreate {
