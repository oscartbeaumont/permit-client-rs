...
pub struct ResponseListResourcesV2SchemaProjIdEnvIdResourcesGet {
    /// List of Resources
...
impl ResponseListResourcesV2SchemaProjIdEnvIdResourcesGet {
    pub fn new(data: Option<serde_json::Value>, total_count: Option<serde_json::Value>) -> ResponseListResourcesV2SchemaProjIdEnvIdResourcesGet {
