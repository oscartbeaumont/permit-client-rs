...
pub struct AccessRequestApproved {
...
impl AccessRequestApproved {
    pub fn new(access_request_details: models::AccessRequestDetails, id: uuid::Uuid, organization_id: uuid::Uuid, project_id: uuid::Uuid, environment_id: uuid::Uuid, created_at: String, updated_at: String, status: models::RequestStatus) -> AccessRequestApproved {
